...
<div class="content-wrapper">
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <a class="btn btn-primary float-right" id="btnTambah" href="javascript:void(0);" data-toggle="modal" data-target="#modalUnit" role="button">
        ...
        <div class="col-12">
          <div class="card card-primary card-outline">
            <div class="card-body table-responsive">
              <table id="tabel_unit" class="table table-bordered table-striped">
                <thead>
                  <tr>
                    <th>No.</th>
                    <th>Nama Satuan</th>
  ...
  <div class="modal fade" id="modalUnit" data-backdrop="static" data-keyboard="false">
        ...
        <form id="formUnit" enctype="multipart/form-data">
          <div class="modal-body">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="unit_name" name="unit_name" autocomplete="off" placeholder="Masukkan nama satuan">
              <small id="unit_name_error" class="text-danger"></small>
            </div>
          </div>
        </form>
...
<script>
    $(document).ready(function() {
        ...
        $('body').on('click', '.btnEdit', function() {
            ...
            const id_unit = $(this).attr('value');
            $.ajax({
                url: "/RubbishUnit/show/" + id_unit,
                type: "GET",
                dataType: "JSON",
        ...
        $('#btnSimpan').on('click', function() {
            ...
            if ($('#modalLabel').text() == "Input Data Jenis") {
                var data = new FormData($("#formUnit")[0]);
                $.ajax({
                    url: "/RubbishUnit/save",
                    method: "POST",
                    data: data,
                    contentType: false,
                    cache: false,
                    ...
                    success: function(data) {
                        if (data.error) {
                            if (data.unit_error['unit_name'] != '') $('#unit_name_error').html(data.unit_error['unit_name']);
                            else $('#unit_name_error').html('');
                        }
                        if (data.success) {
                            $('#formUnit')[0].reset();
