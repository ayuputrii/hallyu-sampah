...
class AdminRubbishModel extends Model
{
  ...
  protected $column_search  = ['datetime', 'id_customer', 'id_rubbish', 'total_deposit', 'total', 'date_delivery', 'status'];
  ...
  function __construct(RequestInterface $request)
  {
    ...
    $this->dt       = $this->db->table($this->table)->select('tb_rubbish_deposit.id, datetime, tb_customers.customer_name, tb_customers.phone, tb_rubbish.rubbish_name, total_deposit, tb_unit.unit_name, total, tb_customers.address, date_delivery, status')
    ...
    ->join('tb_unit', 'tb_unit.id = tb_rubbish.id_unit', 'left');
  }
